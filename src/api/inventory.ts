...
import type { Category, CollectionResponse, CreateInventoryRequest, CreateInventoryResponse, CreateItemRequest, CustomIdRulesRequest, DeleteItemsRequest, FieldType, Inventory, InventoryItem, PaginatedResult, Tag, UpdateCustomFieldsRequest, UpdateItemRequest, ViewInventory, ViewPagesRequest } from '../types/inventory';

export const inventoryApi = {

  updateCustomIdRules: async (request : CustomIdRulesRequest, inventoryId : string) => {
    await apiClient.put(`/inventory/update-custom-id-rules/${inventoryId}`, request);
  },
